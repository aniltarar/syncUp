...
import AdminFeedbackReply from '../../Modals/AdminFeedbackReply';


const AdminFeedbackBox = ({ feedback }) => {
    ...
    return (
        <>
            {
                isReplyModalOpen && <AdminFeedbackReply feedback={feedback} setIsReplyModalOpen={setIsReplyModalOpen} />
            }
            <div className='flex flex-col bg-white border p-3 rounded-md'>
                ...
                {
                    !reply &&
                    <div className='bg-yellow-100 p-3 rounded-md mt-2 cursor-pointer' onClick={() => setIsReplyModalOpen(true)}>
                        <span className='flex items-center gap-x-2'>
                            <FaReply size={16} />
                            <span className='text-sm font-semibold'>Cevap Vermek İçin Tıklayın</span>
                        </span>
                    </div>
