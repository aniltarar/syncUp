...
const LeaderAnnouncementDetail = () => {
    ...
    return (
        <>
            {isOpen && (
                <LeaderCreateAnnouncement setIsOpen={setIsOpen} club={currentClub} />
            )}
            ...
            <div className="flex flex-col gap-y-3">
                ...
                <div className="grid grid-cols-5 gap-3 bg-neutral-100 p-3 rounded-lg shadow font-semibold">
                    ...
                    />
                    <select className="col-span-1 p-2 rounded-lg shadow" onChange={(e) => setSortField(e.target.value)}>
